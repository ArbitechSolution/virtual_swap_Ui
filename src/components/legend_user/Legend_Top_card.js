...
<div className=" mt-3 ">
                    ...
                    <div className=" p-3 d-flex justify-content-between bd-highlight ">
                      ...
                      <div className="top-text-add"><img src={blue} className="img-fluid" width={"62px"}/></div>
                    </div>
    ...
    <div className=" mt-3 ">
                    ...
                    <div className=" p-3 d-flex justify-content-between bd-highlight ">
                      ...
                      <div className="top-text-add"><img src={pink} className="img-fluid" width={"62px"}/></div>
                    </div>
    ...
    <div className=" mt-3 ">
                    ...
                    <div className=" p-3 d-flex justify-content-between bd-highlight ">
                      ...
                      <div className="top-text-add"><img src={yellow} className="img-fluid" width={"62px"}/></div>
                    </div>
