...
function Wining() {
  return (
    ...
    <div className='twining_criteria'>
    Winning Criteria
    </div>
    ...
    <div className='there_an'>
        ...
        <p>
        <span>
            <img src={ticketA} className="img-fluid" width={"56px"}/>
        </span>
Ticket A: The first 3 digits and the last 2 digits match, but the 4th 
      digit is wrong, so this ticket only wins a “Match first 3” prize.
        </p>
        <p>
        <span>
            <img src={ticketB} className="img-fluid" width={"56px"}/>
        </span>
Ticket A: The first 3 digits and the last 2 digits match, but the 4th 
      digit is wrong, so this ticket only wins a “Match first 3” prize.
        </p>
...
you’ll only win prizes from the ‘Match 3’ bracket, and not from 
‘Match 1’ and ‘Match 2’.
        </p>
    </div>

    </div>
    <div className='col-md-6 wining-box'>
...
<img src={circleA} className="img-fluid" width={"46px"}/>


<img src={circleB} className="img-fluid"  width={"46px"}/>


<img src={circleC} className="img-fluid"  width={"46px"}/>


<img src={circleD} className="img-fluid"  width={"46px"}/>


<img src={circleE} className="img-fluid"  width={"46px"}/>

<img src={circleF} className="img-fluid"  width={"46px"}/>
</div>
